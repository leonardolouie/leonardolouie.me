...
export default function ProfileCard({ name, job, location, description, promotion, social }) {
  return (
    <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white  mx-6 lg:mx-0 bg-primary text-white">
      <div className="p-4 md:p-12 text-center lg:text-left">
        ...
        1<p className="pt-8 text-sm">{description}</p>
